...
+ (UIColor *)_customGrayColor
{
    return [self colorWithRed:248 green:248 blue:248];
}

+ (UIColor *)_customGrayChatColor{
    return [self colorWithRed:239 green:239 blue:239];
}

+ (UIColor *)_customGrayChatBoundsLineColor{
    return [self colorWithRed:129 green:129 blue:129];
}

+ (UIColor *)_customGrayChatBoundsColor{
    return [self colorWithRed:176 green:176 blue:176];
}
